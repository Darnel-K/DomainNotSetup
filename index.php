...
<body>
    <div>
        <h1>You Shouldn't Be Here!</h1>
            ...
            ?>
        <p id="info"><?php echo date("d/m/Y h:i:s A T"); ?> &bull; <?php echo date("e"); ?> &bull; Your IP <?php echo $_SERVER['REMOTE_ADDR']; ?> &bull; <a href="mailto:<?php echo $_SERVER['SERVER_ADMIN']; ?>"></a></p>
    </div>

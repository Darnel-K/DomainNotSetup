            ...
            <h1>You Shouldn't Be Here!</h1>
                <?php
                    if ($_SERVER['HTTP_HOST'] == gethostbyname($_SERVER['HTTP_HOST'])) {
                        ...
                        $admin = $_SERVER['SERVER_ADMIN'] . "?subject=" . rawurlencode("Direct IP access is forbidden");
                        ...
                        $admin = $_SERVER['SERVER_ADMIN'] . "?subject=" . rawurlencode("Host '" . $_SERVER['HTTP_HOST'] . "' is non-existent");
